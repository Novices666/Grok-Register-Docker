...
OAUTH_MIN_INTERVAL_SEC=${OAUTH_MIN_INTERVAL_SEC:-6}
OAUTH_RETRY_SEC=${OAUTH_RETRY_SEC:-60}
...
# Web/Docker start default for -j only; CLI grok start ignores this key (upstream).
